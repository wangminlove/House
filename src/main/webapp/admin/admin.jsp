	 ...
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"区域管理",
							"menus":[
									...
									{"menuid":"16","menuname":"街道明细","icon":"icon-log","url":"Street.jsp"}
								]
						},{"menuid":"8","icon":"icon-sys","menuname":"用户管理",
							"menus":[{"menuid":"21","menuname":"员工列表","icon":"icon-nav","url":"User.jsp"},
									{"menuid":"22","menuname":"视频监控","icon":"icon-nav","url":"demo1.html"}
								]
						},{"menuid":"56","icon":"icon-sys","menuname":"房屋审核",
							"menus":[{"menuid":"31","menuname":"未审核","icon":"icon-nav","url":"house01.jsp"},
									{"menuid":"32","menuname":"已审核","icon":"icon-nav","url":"house02.jsp"}
								]
						},{"menuid":"28","icon":"icon-sys","menuname":"类型管理",
							"menus":[{"menuid":"41","menuname":"房屋类型","icon":"icon-nav","url":"type.jsp"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head">欢迎 ${sessionScope.loginInfo.name} <a href="#" id="editpass" style="color:#fff;">修改密码</a> <a href="#" id="loginOut" style="color:#fff;">安全退出</a></span>
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">后台管理系统  版权归王敏所有  联系方式:13647225040</div>
    </div>
